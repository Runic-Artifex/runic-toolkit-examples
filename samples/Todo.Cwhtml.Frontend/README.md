...
Vite bundles those dependencies with the WebUIToolkit native HTMX bridge and
...
Run `npm run dev --workspace @webuitoolkit/sample-todo-cwhtml` for the bounded
Vite build watcher, or use `dotnet webuitoolkit dev` from either cwhtml sample

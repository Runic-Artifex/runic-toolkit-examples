...
if (Array.Exists(args, static argument => argument == "--native-e2e"))
    return await SetupNativeE2E.RunAsync();
...
var options = new ApplicationBridgeFrontendApplicationOptions(
    ...
    new BrowserHostOptions("runic-toolkit-setup"),
    new BrowserWindowOptions("main", "Runic Toolkit · Setup", 980, 720),
...
await using ApplicationBridgeFrontendApplication frontend =
    builder.UseApplicationBridge("Setup", options);

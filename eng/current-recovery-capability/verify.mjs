...
async function one(provenance) {
  ...
  try {
    ...
    if (summary.output.includes(editor) || summary.output.includes("de/common_save.mf2") || summary.output.includes("Speichern")) throw new Error("Editor diagnostics leaked workspace or translation text");
